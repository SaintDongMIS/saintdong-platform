...
export const BankConverterConfig = {
  // 付款人戶名（固定，Big5 編碼的 bytes，70 bytes）
  PAYER_NAME_BYTES: Buffer.from([
    0xb8, 0x74, 0xaa, 0x46, 0xc0, 0xe7, 0xb3, 0x79, 0xaa, 0xd1, 0xa5, 0xf7,
    0xa6, 0xb3, 0xad, 0xad, 0xa4, 0xbd, 0xa5, 0x71, 0x20, 0x20, 0x20, 0x20,
